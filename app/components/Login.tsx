  ...
  return (
    <div className="flex flex-col justify-start items-center h-auto w-auto py-6 px-10 bg-black font-jetbrains text-white shadow-lg/45 rounded-lg">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-3">
        ...
        <button className="mt-5  p-2 rounded-lg bg-secondary text-black border border-transparent hover:bg-dark hover:text-white hover:border-accent transition-colors duration-300">
          Log In
        </button>
      </form>
    </div>
